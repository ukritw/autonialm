...
class GRUDisaggregator(Disaggregator):
    ...
    def train(self, mains, meter, epochs, batch_size=128, **load_kwargs):
        '''Train
    ...
    def train_on_chunk(self, mainchunk, meterchunk, epochs, batch_size):
        ...
        self.model.fit(mainchunk, meterchunk, epochs=epochs, batch_size=batch_size, shuffle=True, validation_split=0.2, callbacks=callbacks_list)
