...
def lstm(dataset_path, train_building, train_start, train_end, test_building, test_start, test_end, meter_key, sample_period, num_epochs, patience,optimizer, learning_rate, loss):
    ...
    #rnn.export_model("results/rnn-model-{}-{}epochs.h5".format(meter_key, num_epochs))
...
#     with open('results/rnn_json.json', 'a+') as outfile:
...
#     main()
#
#     # python rnn.py --datapath ../data/REDD/redd.h5 --train_building 1 --train_end 2011-05-10 --test_building 1 --test_start 2011-05-10 --appliance fridge --sampling_rate 20 --epochs 100
#     # python rnn.py --datapath /mnt/data/datasets/wattanavaekin/REDD/redd.h5 --train_building 1 --train_end 2011-05-10 --test_building 1 --test_start 2011-05-10 --appliance fridge --sampling_rate 20 --epochs 100
